<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserControlMap.aspx.cs" Inherits="Portfolio.UserControlMap" %>
<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>User Control Map</title>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#btnAdd").click(function () {
                ...
                InsertUSerControlMAp();


            });

            GetUserDropdown();
            GetUserControlDropdown();
            GetProjectDropdown();
            GetUserControlMap();
        });
    </script>
...
<body>
    <form id="form1" runat="server">
        <div class="container-fluid">
         <div class="row">
            <div class="col-sm-12">
                <h1 style="text-align: center;">User Control Maping</h1>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="col-md-3">
                    ...
                    <br />
                    <select id="ddlControl" name="multicheckbox[]" multiple="multiple">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="table-responsive">
                    <table id="tblUserControlMAp" class="display" style="width: 100%">
                        <thead>
                            <tr>
                               <th>User</th>
                                <th>Control</th>
