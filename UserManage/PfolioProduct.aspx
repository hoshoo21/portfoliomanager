<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PfolioProduct.aspx.cs" Inherits="Portfolio.PfolioProduct" %>
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="table-responsive">
                        <table id="tblPfolioProduct" class="display" style="width: 100%">
                            <thead>
                                <tr>
                                    <th>Product Code</th>
                                    <th>Product</th>
