<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UploadStockPrice.aspx.cs" Inherits="Portfolio.UploadStockPrice" %>
    ...
    <script type="text/javascript">
        ...
        function ProcessExcel(data) {
            ...
            for (var i = 0; i < excelRows.length; i++) {
                ...
                //Add the data cells.
                if (excelRows[i]['Ticker'] == null) {
                    stockname = "";
                } else {
                    stockname = excelRows[i]['Ticker'];
                }


                if (excelRows[i]['Date'] == null) {
                    tractDate = "";
                }
                else {
                    tractDate = excelRows[i]['Date'];
                }
        ...
        function insertExcelData(stockname, tractDate, stocstockhigh, stockLow, stockOpen, stockClose, stockvolume, stockadjClose) {
            if ($('#ddlContry option:selected').test() == 'Pakistan') {
                ...
                $.ajax({
                    url: "api/XBRL/GetStockHistoryUSA",
                    data: ajax_data,
                    type: 'GET',
                    dataType: 'json',
                    success: function (data) {
    ...
    <form id="form1" runat="server">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-12">
                      <div class="col-sm-3">
                        <select class="form-control"style="width:250px" id="ddlContry">
